...
whomap <- function (X,
            ...
            legend.pos = c(0.09, 0.26))
  {
    ...
    SDN <-
      subset(
        ...
        !(long > 25 &
            ...
            long < 34 &
            lat > 9) &
          !(long > 33.2 & lat < 23 & long < 35 & lat > 21.5) & id == 'SDN'
      )
    SDN[14:31, 'group2'] <- 'SDN.1.2'
    SDN[32:33, 'group2'] <- 'SDN.1.3'
    EGY <-
      subset(gworlddash,
             !(long > 33.2 & lat < 23 & long < 35 & lat > 21.5) & id == 'EGY')
    ...
    KOR <-
      subset(gworlddash,
             !(long > 127 & lat < 38.5 & long < 127.5 & lat > 38) & id == 'KOR')
    KOR <- KOR[1:10, ]
    PRK <-
      subset(gworlddash,
             !(long > 127 & lat < 38.5 & long < 127.5 & lat > 38) & id == 'PRK')
